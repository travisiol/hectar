...
const entries = [
  ...
  },
  {
    ...
    a: "Brightness is activity. A green hexagon has a market open, and the brighter it burns the more is being traded on it. The one that has pulled in the most owners turns cyan. Right now every plot is an empty outline, because no market has been opened anywhere.",
  },
  {
